...
end JustButtons_stub;

architecture STRUCTURE of JustButtons_stub is

  component JustButtons is
    port (
      SWs_8Bits_TRI_IO : inout std_logic_vector(7 downto 0);
      LEDs_8Bits_TRI_IO : out std_logic_vector(7 downto 0);
      BTNs_5Bits_TRI_IO : inout std_logic_vector(4 downto 0);
  ...
  attribute BOX_TYPE of JustButtons : component is "user_black_box";

begin

  JustButtons_i : JustButtons
    port map (
